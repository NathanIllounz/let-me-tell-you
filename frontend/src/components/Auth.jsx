    ...
    <div className="w-full p-8 sm:p-10 bg-[#FDFBF7] rounded-xl">
      <div className="text-center mb-10">
        ...
        <p className="text-stone-500 mt-3 text-lg font-medium">
          {mode === 'login' ? 'Log in to access your family history.' : 'Sign up to start saving your stories.'}
        </p>
      </div>
      ...
      <div className="relative flex items-center py-2 mb-8">
        ...
        <span className="flex-shrink-0 mx-4 text-stone-400 text-sm font-medium uppercase tracking-wider">Or continue with email</span>
        <div className="flex-grow border-t border-stone-200"></div>
      </div>
