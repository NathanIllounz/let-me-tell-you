    ...
    <div className="flex flex-col font-sans bg-[#FDFBF7] overflow-x-hidden">
      ...
      <header className="absolute top-0 w-full z-30 py-6 px-8 flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div className="relative w-12 h-12 flex items-center justify-center p-2 bg-gradient-to-br from-[#c9a174] to-[#8F7C6B] rounded-xl shadow-[0_8px_16px_rgba(0,0,0,0.4)] border border-white/20">
            <BookOpen
              className="text-white/80 w-6 h-6 absolute mt-2 ml-1"
              strokeWidth={1.5}
            />
            <Feather
              className="text-white w-7 h-7 absolute -mt-3 mr-2 rotate-[15deg] drop-shadow-md"
              strokeWidth={2.5}
            />
          </div>
        ...
        <div className="relative z-10 w-full lg:w-1/2 flex flex-col justify-center px-8 lg:px-16 mt-10 lg:mt-0 lg:min-h-screen">
          ...
          <FadeInSection delay={300} slide={false}>
            <p className="text-xl lg:text-2xl text-stone-200 mb-10 max-w-xl leading-relaxed drop-shadow-[0_2px_2px_rgba(0,0,0,0.8)]">
              Discover, record, and intimately share the precious memories that
              make you who you are. A beautiful digital heirloom for generations
              to come.
            </p>
          </FadeInSection>
        ...
        <div className="max-w-7xl mx-auto">
          <FadeInSection>
            <div className="text-center mb-16">
              ...
              <h3 className="text-[#a4917a] uppercase tracking-widest font-bold text-sm mb-3">
                Magical Technology
              </h3>
              <h2 className="text-4xl lg:text-5xl font-serif font-bold text-[#FDFBF7]">
                Everything needed to immortalize a memory.
              </h2>
            </div>
          </FadeInSection>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <FadeInSection delay={0}>
              <div className="bg-[#3a3025] hover:bg-[#45392d] p-8 rounded-2xl shadow-xl transition-all duration-300 group h-full border border-white/5 relative overflow-hidden">
                ...
                <p className="text-[#b5a38f] leading-relaxed font-medium">
                  Just speak naturally into your phone. Our Ghostwriter takes
                  your wandering thoughts and elegantly formats them into a
                  polished memoir chapter.
                </p>
              </div>
            </FadeInSection>
            ...
            <FadeInSection delay={200}>
              <div className="bg-[#3a3025] hover:bg-[#45392d] p-8 rounded-2xl shadow-xl transition-all duration-300 group h-full border border-white/5 relative overflow-hidden">
                ...
                <p className="text-[#b5a38f] leading-relaxed font-medium">
                  No stock photos here. Every story receives beautifully
                  customized, generative painted cover art complete with premium
                  typography printed on the cover.
                </p>
              </div>
            </FadeInSection>
            ...
            <FadeInSection delay={400}>
              <div className="bg-[#3a3025] hover:bg-[#45392d] p-8 rounded-2xl shadow-xl transition-all duration-300 group h-full border border-white/5 relative overflow-hidden">
                ...
                <p className="text-[#b5a38f] leading-relaxed font-medium">
                  Too tired to read? Listen to your family's stories on the go,
                  narrated automatically by hyper-realistic AI voices in over 40
                  different languages.
                </p>
              </div>
            </FadeInSection>
            ...
            <FadeInSection delay={600}>
              <div className="bg-[#3a3025] hover:bg-[#45392d] p-8 rounded-2xl shadow-xl transition-all duration-300 group h-full border border-white/5 relative overflow-hidden">
                ...
                <p className="text-[#b5a38f] leading-relaxed font-medium">
                  Form private "Family Circles" or share direct secure handles
                  with friends. Your legacy remains totally private until you
                  decide to bridge the connection.
                </p>
              </div>
            </FadeInSection>
          </div>
      ...
      <div className="bg-[#FDFBF7]">
        <div className="max-w-7xl mx-auto px-8 lg:px-16 pt-10 pb-20">
          <FadeInSection>
            <div className="text-center mb-16">
              <h2 className="text-4xl lg:text-5xl font-serif font-bold text-stone-800 drop-shadow-sm">
            ...
            <div className="w-full lg:w-1/2">
              <FadeInSection delay={300}>
                <div className="flex items-center gap-4 mb-4">
                  <span className="px-4 py-1.5 bg-[#F3EBE1] text-[#6B8569] font-bold text-xs uppercase tracking-widest rounded-full">
                    Archive
                  </span>
                </div>
                <h3 className="text-3xl lg:text-4xl font-bold font-serif text-stone-800 mb-6">
                  Interview the previous generation.
                </h3>
                <p className="text-lg text-stone-500 leading-relaxed">
                  Capture history before it slowly fades away. Sit down with a
                  phone over coffee, press record, and easily archive an entire
                  lifetime of memories in their own unscripted words.
                </p>
              </FadeInSection>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-8 lg:px-16">
          <div className="flex flex-col lg:flex-row-reverse items-center gap-16">
            ...
            <div className="w-full lg:w-1/2">
              <FadeInSection delay={300}>
                <div className="flex items-center gap-4 mb-4">
                  <span className="px-4 py-1.5 bg-[#2c3e50] text-[#86a6c1] font-bold text-xs uppercase tracking-widest rounded-full border border-[#34495e]">
                    Imagination
                  </span>
                </div>
                <h3 className="text-3xl lg:text-4xl font-bold font-serif text-white mb-6">
                  The definitive bedtime story collection.
                </h3>
                <p className="text-lg text-[#86a6c1] leading-relaxed">
                  Parents can easily record the wild, totally improvised tales
                  they make up for their kids every night. Our app binds them
                  with beautiful AI art, making them feel like real published
        ...
        <div className="max-w-7xl mx-auto px-8 lg:px-16">
          <div className="flex flex-col lg:flex-row items-center gap-16">
            ...
            <div className="w-full lg:w-1/2">
              <FadeInSection delay={300}>
                <div className="flex items-center gap-4 mb-4">
                  <span className="px-4 py-1.5 bg-stone-100 text-stone-600 font-bold text-xs uppercase tracking-widest rounded-full">
                    Culture
                  </span>
                </div>
                <h3 className="text-3xl lg:text-4xl font-bold font-serif text-stone-800 mb-6">
                  Preserve the sacred recipes.
                </h3>
                <p className="text-lg text-stone-500 leading-relaxed">
                  Document the chaotic, beautiful history of *why* Aunt Marie's
                  lasagna is famous. Record the recipe alongside the actual
                  story of the kitchen disasters that led to it.
                </p>
              </FadeInSection>
            </div>
          </div>
        ...
        <div className="max-w-4xl mx-auto px-8 text-center flex flex-col items-center">
          <FadeInSection>
            <div className="relative w-16 h-16 flex items-center justify-center p-3 bg-gradient-to-br from-[#c9a174] to-[#8F7C6B] rounded-2xl shadow-[0_12px_24px_rgba(0,0,0,0.6)] border border-white/10 mb-8 mx-auto">
              <BookOpen
                className="text-[#1e1a17]/50 w-8 h-8 absolute mt-2 ml-1"
                strokeWidth={2}
              />
              <Feather
                className="text-[#1e1a17] w-10 h-10 absolute -mt-4 mr-2 rotate-[15deg] drop-shadow-md"
                strokeWidth={2.5}
              />
            </div>
            <h2 className="text-4xl font-serif font-bold text-white mb-4">
              Protect your memories with
            </h2>
            <h1 className="text-5xl lg:text-6xl font-serif font-bold text-[#c9a174] mb-8 drop-shadow-lg">
              Let Me Tell You
            </h1>
            <p className="text-[#a4917a] text-lg mb-12 max-w-lg mx-auto font-medium tracking-wide">
              Scroll back up to sign in and start building your family's
              definitive, secure library.
            </p>
            <button
      ...
      <footer className="footer py-8 bg-black text-stone-500 text-center text-sm">
        <p>
          © {new Date().getFullYear()} Let Me Tell You. A digital heirloom
          project.
        </p>
      </footer>
    </div>
