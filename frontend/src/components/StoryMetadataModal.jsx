...
export default function StoryMetadataModal({
  story,
  session,
  groups,
  onClose,
  ...
  const initialGroups = story.story_groups
    ? story.story_groups.map((sg) => sg.group_id)
    : [];
  ...
  const handleGenerateAICover = async () => {
    ...
    try {
      const res = await api.post(`/stories/${story.id}/generate-cover`, null, {
  ...
  return (
    <div className="fixed inset-0 z-50 p-4 bg-black/40 backdrop-blur-sm animate-in fade-in overflow-y-auto">
      <div className="flex min-h-full items-start justify-center pt-16 pb-4">
        <div className="bg-white rounded-2xl shadow-xl w-full max-w-sm p-6 relative">
          ...
          <h3 className="text-xl font-bold font-serif mb-6 text-stone-800">
            Story Settings
          </h3>
          ...
          <div className="space-y-4">
                ...
                <div className="flex items-center gap-4">
                  {generatingCover ? (
                    ...
                    <img
                      src={previewUrl}
                      alt="Cover"
                      className="w-10 h-14 object-cover rounded shadow-sm border border-stone-300"
                    />
                  ) : (
                    ...
                    <div className="flex gap-2 items-center">
                      ...
                      {previewUrl && !generatingCover && (
                        <button
                          ...
                          className="text-[11px] text-red-500 hover:text-red-700 font-medium px-2"
                        >
                          Remove
                        </button>
                      )}
            ...
            <div>
              ...
              <p className="text-[10px] text-stone-400 mt-1">
                Language is locked once a story is generated.
              </p>
            </div>
          </div>
          <button
